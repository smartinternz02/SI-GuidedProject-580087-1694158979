    ...
    Column(modifier = Modifier.fillMaxSize()) {
        TopAppBar(title = {
            Row(modifier = Modifier.height(56.dp),
                ...
                Image(painter = painterResource(id = hotel), contentDescription = "Logo",
        ...
        Column(modifier = Modifier
            ...
            Column(modifier = Modifier.fillMaxHeight().padding(bottom = 10.dp),
                ...
                Text(text = "THANK YOU FOR ORDERING", style = TextStyle(fontSize = 26.sp, fontFamily = FontFamily(
    ...
    Card(modifier = Modifier
        ...
        Column(modifier = Modifier.padding(horizontal = 13.dp)) {
            ...
            Row(modifier = Modifier
                ...
                Text(text = "GST and restaurant charges", style = TextStyle(fontSize = 17.sp, fontFamily = FontFamily(
            ...
            Row(modifier = Modifier
                ...
                Image(painter = painterResource(id = R.drawable.baseline_directions_bike_24), contentDescription = "Gov",
                    modifier = Modifier.size(21.dp))
                Text(text = "Delivery partner fees", style = TextStyle(fontSize = 17.sp, fontFamily = FontFamily(
                    Font((R.font.roboto_regular), weight = FontWeight(1))
                )), modifier = Modifier.padding(start = 6.dp))
                Row(modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.End) {
